...
export function CourseConclusionCTA({ palette }: CourseConclusionCTAProps) {
  return (
    <section className="relative py-32 px-4 overflow-hidden border-t border-white/5 bg-[#050505]">
      ...
      <div className="container mx-auto max-w-4xl relative z-10 text-center flex flex-col items-center">
        ...
        <p className="mt-8 text-sm text-[#A1A1AA]">
          Have questions? <a href="/contact" className="text-white hover:underline">Talk to an admissions counselor</a>.
        </p>
      </div>
    </section>
  )
