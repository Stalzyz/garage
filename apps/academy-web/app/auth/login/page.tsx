      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col items-center text-center mb-10">
            ...
            <h1 className="text-3xl font-bold tracking-tighter mb-2">Grekam Visuals</h1>
          ...
          <div className="mt-8 text-center">
             <Link href="/academy/login" className="text-xs font-mono tracking-widest text-white/40 hover:text-white/80 transition-colors uppercase">
