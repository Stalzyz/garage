...
export default function AdmissionsPage() {
  ...
  const handleCreateApp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setIsAddOpen(false)
      setFormData({ firstName: "", lastName: "", email: "", phone: "", courseId: "", portfolioUrl: "", statement: "" })
      mutate()
    } catch (err: any) {
  ...
  const columns = [
    ...
    { id: 'INTERVIEW_SCHEDULED', title: 'Interview Scheduled', color: 'bg-purple-500' },
    { id: 'ADMITTED', title: 'Accepted / Enrolled', color: 'bg-emerald-500' },
  ...
  return (
    <div className="flex flex-col h-full bg-[#050505] text-white overflow-hidden">
      ...
      <SlideOver
        ...
        subtitle="Create a new admission application for a prospective student."
      >
