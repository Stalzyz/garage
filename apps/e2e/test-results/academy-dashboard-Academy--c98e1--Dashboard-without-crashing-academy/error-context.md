...
- Name: academy-dashboard.spec.ts >> Academy Dashboard Production Tests >> should load the AI Risk Dashboard without crashing
- Location: tests/academy-dashboard.spec.ts:15:7
