...
const LayoutCreativeOS = ({ cards, playSound }: any) => {
  ...
  return (
    <div className="h-[100dvh] w-full bg-zinc-950 overflow-hidden relative font-sans text-white">
      ...
      <AnimatePresence>
         {activeCard && (
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none p-4 md:p-12 mb-24 md:mb-32">
...
const LayoutCreativeUniverse = ({ cards, playSound }: any) => {
  ...
  return (
    <div className="h-[100dvh] w-full bg-[#030014] overflow-hidden relative flex items-center justify-center font-sans">
      ...
      <AnimatePresence>
        {activeCard && (
           <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 50 }} className="absolute bottom-0 md:bottom-10 left-0 right-0 z-50 flex justify-center p-4 pointer-events-none">
...
export default function GrekamOSAgency() {
