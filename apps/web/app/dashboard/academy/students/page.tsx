...
export default function StudentDirectory() {
  ...
  const { data: studentsData, mutate: refreshStudents } = useApi<any>("/academy/students")
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs font-mono tracking-widest uppercase text-white/40 mt-1">Academy Enrollment Telemetry</p>
            </div>
          </div>
