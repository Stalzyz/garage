  ...
  return (
    <div className="h-screen w-full bg-[#050505] text-[#f4f4f4] overflow-hidden relative flex flex-row font-sans selection:bg-white/30 cursor-crosshair">
      ...
      <div className="absolute top-0 right-0 p-8 z-50">
        <Link 
          href="/auth/login" 
          className="px-6 py-2.5 rounded-full border border-white/20 text-white text-xs font-bold tracking-widest uppercase hover:bg-white hover:text-black transition-all backdrop-blur-md shadow-lg"
        >
          Login / Register
        </Link>
      </div>
