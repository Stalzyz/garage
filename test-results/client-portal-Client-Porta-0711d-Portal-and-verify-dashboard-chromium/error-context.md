...
- Name: client-portal.spec.ts >> Client Portal Experience >> should navigate to Client Portal and verify dashboard
- Location: tests/e2e/client-portal.spec.ts:9:7
...
Call log:
  ...
  - waiting for locator('h1').first()
    21 × locator resolved to <h1 class="text-3xl font-bold tracking-tighter mb-2">Grekam OS</h1>
